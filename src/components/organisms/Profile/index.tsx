  ...
  return (
    <div className="container mx-auto sm:p-6">
      ...
      <div className="relative">
        <div className="absolute inset-0 bg-secondary opacity-75 rounded-lg"></div>
        <div className="relative z-10 sm:p-6 p-2">
          ...
          <div className="flex items-center justify-between mb-6 sm:flex-row flex-col">
            ...
            <Button
              ...
              variant="secondary"
              className="flex items-center space-x-2 sm:mt-0 mt-6"
            >
              {isEditing ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="col-span-2 bg-gray-100 dark:bg-gray-800">
              <CardHeader>
